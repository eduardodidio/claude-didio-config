---
name: architect
description: Architect — Create Feature
kind: role-prompt
...
<!-- /didio:claude -->
<!-- didio:codex -->
     pulled from `AGENTS.md`, code snippets/patterns to follow, gotchas.
<!-- /didio:codex -->
...
<!-- /didio:claude -->
<!-- didio:codex -->
     test files live, mocking/fixture conventions (from `AGENTS.md`)
<!-- /didio:codex -->
...
<!-- /didio:claude -->
<!-- didio:codex -->
values. Tests run via the stack's standard test command (see `AGENTS.md`).
<!-- /didio:codex -->
