---
name: developer
description: Developer — Implement Task
kind: role-prompt
...
<!-- /didio:claude -->
<!-- didio:codex -->
- Follow the stack conventions described in `AGENTS.md`
<!-- /didio:codex -->
...
<!-- /didio:claude -->
<!-- didio:codex -->
- Run the stack's test command (see `AGENTS.md` → Testing section) and do
<!-- /didio:codex -->
