...
1. **🚀 Trabalho** — criar feature, POC from meeting, criar PRD, corrigir bug, revisar branch, planejar feature
   _(opções 1, 2, 3, 14, 16, 20)_ — Trabalho tem 6 itens; use 4 na pergunta + "Other" para ver mais
